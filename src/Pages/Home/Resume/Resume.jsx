           ...
           <div className='grid grid-cols-2 gap-10 mx-10'>
            ...
            <div className='py-4'>
                ...
                <div className='bg-[#FFE3BF] py-10 px-2 rounded-xl'>
                    ...
                    <h1 className='text-xl font-semibold'>Technical Mentor </h1>
                    <h1 className='text-xl'>Moringa School </h1>
                </div>
                <div className='bg-[#FFE3BF] mt-5 py-10 px-2 rounded-xl'>
                    <p className='text-slate-400'>2021-2022</p>
                    <h1 className='text-xl font-semibold'>Website Development  </h1>
                    <h1 className='text-xl'>Village 2 Nation </h1>
                </div>
            </div>
           </div>
           
           <div className='grid grid-cols-2 gap-2  h-fit  bg-[#F8FBFB] pb-8 rounded-b-2xl '>
            <div className='py-4 mx-10'>
                ...
                <div className=' pt-5  flex flex-wrap  gap-5 text-center'>
                    <div className="text-[16px] px-2 py-1 bg-slate-300 rounded-lg ">NEXT.js</div>
